...
int main(int argc, char **argv) {
  ...
  i =  load_image("C:/Users/sapph1ren/Pictures/cat_mrh.jpg");
  int fps = 30;
  ...
  while (r_loop() == 0) {   
	...
	case MU_COMMAND_IMAGE: {
	    mu_ImageCommand *img_cmd = (mu_ImageCommand*)cmd;
	    r_Image *img = (r_Image*)img_cmd->framebuffer; 

	    if (img && img->pixels) {
		r_draw_image(ctx, img_cmd->rect, img);
	    }
	} break;
