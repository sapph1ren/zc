...
typedef struct { mu_BaseCommand base; mu_Rect rect; void* framebuffer; int w; int h } mu_ImageCommand;
...
void mu_draw_image(mu_Context *ctx, mu_Rect rect, void* framebuffer, int w, int h);
